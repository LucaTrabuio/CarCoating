      ...
      {featured && (
        <section className="py-8 px-5 bg-amber-50">
          <div className="max-w-[900px] mx-auto grid md:grid-cols-2 gap-6">
            ...
            <div>
              <div className="text-xs text-amber-600 font-bold mb-1">PICKUP</div>
      ...
      <section className="py-10 px-5 bg-[#0f1c2e]">
        <div className="max-w-[500px] mx-auto text-center text-white">
          ...
          <div className="flex gap-3 justify-center">
            <Link href={`${base}/booking`} className="px-6 py-2.5 bg-amber-500 text-white font-bold rounded-md text-sm hover:bg-amber-600">予約する →</Link>
