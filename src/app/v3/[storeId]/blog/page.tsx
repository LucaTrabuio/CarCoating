...
export default async function V3BlogPage({ params }: { params: Promise<{ storeId: string }> }) {
      ...
      <section className="py-12 px-5 bg-[#0f1c2e]">
        <div className="max-w-[500px] mx-auto text-center text-white">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <Link href={`${base}/booking`} className="px-5 py-2.5 bg-amber-500 text-white font-bold rounded-md text-sm hover:bg-amber-600">ご予約・お問い合わせ →</Link>
          </div>
        </div>
      </section>
    </main>
