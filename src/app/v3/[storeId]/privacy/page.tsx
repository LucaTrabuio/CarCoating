  ...
  return (
    <main className="py-14 px-5">
      <div className="max-w-[700px] mx-auto">
        ...
        <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mt-2">
              ...
              <p>{store.address}</p>
              <p>TEL: <a href={`tel:${store.tel}`} className="text-amber-600 font-bold">{store.tel}</a></p>
        ...
        <div className="mt-8">
          <Link href={base} className="text-amber-600 text-sm font-semibold hover:underline">← 店舗トップに戻る</Link>
        </div>
      </div>
    </main>
  );
