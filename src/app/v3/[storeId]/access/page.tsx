        ...
        <div className="max-w-[1100px] mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><span className="text-xs text-gray-400 block mb-0.5">電話番号</span><a href={`tel:${store.tel}`} className="font-bold text-amber-600">{store.tel}</a></div>
        ...
        <section className="py-10 px-5 bg-gray-50">
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {otherStores.map(s => (
                <Link key={s.store_id} href={`/v3/${s.store_id}/`}
