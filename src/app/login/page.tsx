  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      if (msg.includes('auth/popup-closed-by-user')) {
        ...
        setError('このドメインはGoogle認証に許可されていません。Firebase Consoleで設定してください。');
      } else {
        setError(msg);
      }
    } finally {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg p-8 shadow-xl space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white border border-gray-300 rounded-md font-semibold text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
          >
