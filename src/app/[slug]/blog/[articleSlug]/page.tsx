    ...
    <main>
      ...
      <section className="py-12 px-5 bg-[#0C3290]">
        <div className="max-w-[500px] mx-auto text-center text-white">
          ...
          <Link href={`${base}/booking`} className="inline-block px-8 py-3 bg-amber-500 text-[#0C3290] font-bold rounded-xl text-sm hover:bg-amber-500 transition-colors">ご予約・お問い合わせ →</Link>
        </div>
      </section>
    </main>
  );
