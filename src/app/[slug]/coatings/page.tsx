                ...
                <div className="text-right">
                  ...
                  {isBlurred(tier.id, 'web_price', blurFields) ? (
                    <div className="relative inline-block">
                      <div style={{ filter: 'blur(8px)' }} className="select-none pointer-events-none text-2xl font-bold text-[#0C3290]" aria-hidden="true">{formatPrice(getPriceForSize(tier, 'SS', priceOverrides))}</div>
