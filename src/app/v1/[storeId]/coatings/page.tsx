/*
 * Coatings page — store-specific version (with storeId)
 * All pricing tables fully visible — NO BlurOverlay
 */
...
import { getBaseUrl, getStoreByIdAsync } from '@/lib/store-data';
...
export default async function StoreCoatingsPage({
  params,
}: {
  params: Promise<{ storeId: string }>;
}) {
        ...
        return (
          ...
          >
            <div className={`max-w-[900px] mx-auto border-l-4 ${accent} pl-6`}>
              ...
              {/* Pricing by size — fully visible, NO BlurOverlay */}
