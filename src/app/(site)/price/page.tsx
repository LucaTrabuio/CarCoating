        ...
        <>
          <section className="py-12 px-5">
            <div className="max-w-[1100px] mx-auto">
              ...
              <BlurOverlay ctaText="料金を確認する" ctaHref="/booking?mode=inquiry" subtitle="正確な料金はご予約・お問い合わせ時にご案内します">
                <PricingTable size={selectedSize} discountRate={discountRate} storeId="" />
              </BlurOverlay>
            </div>
          </section>
          ...
          <section className="py-12 px-5">
            <div className="max-w-[1100px] mx-auto">
              ...
              <BlurOverlay ctaText="比較表を見る" ctaHref="/booking?mode=inquiry" subtitle="詳細な比較はご予約・お問い合わせ時にご案内します">
          ...
          <section className="py-12 px-5 bg-gray-50">
            <div className="max-w-[800px] mx-auto">
              ...
              <BlurOverlay ctaText="コスト比較を見る" ctaHref="/booking?mode=inquiry" subtitle="長期コストの詳細はご予約・お問い合わせ時にご案内します">
