...
export const metadata = {
  title: '店舗一覧｜KeePer PRO SHOP カーコーティング専門店',
  description: 'KeePer PRO SHOP 全店舗一覧。お近くの店舗をお選びください。',
};
      ...
      <div className="max-w-[900px] mx-auto px-5 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-white/40 text-sm">
            全{stores.length}店舗のKeePer認定プロショップ。お近くの店舗をお選びください。
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Link href="/" className="text-white/30 text-xs hover:text-white/60 transition-colors">← マーケティングサイトに戻る</Link>
        </div>
      </div>
    </main>
  );
