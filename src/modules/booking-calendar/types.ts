// Module version of reservation types
// Original: src/lib/reservation-types.ts
...
/** Calendar cell data used by CalendarGrid */
...
/** Calendar cell status info */
export interface CellStatus {
  status: 'out' | 'open' | 'holiday' | 'closed-template' | 'closed-override' | 'override';
  holiday?: string;
