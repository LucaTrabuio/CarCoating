      ...
      <div className="flex gap-3 flex-wrap items-end">
        <div className="flex-1 min-w-[140px]">
          ...
          <select
            ...
            className="w-full h-11 px-4 text-sm rounded-lg border-2 border-gray-200 bg-white focus:border-amber-500 focus:outline-none appearance-none cursor-pointer"
          >
