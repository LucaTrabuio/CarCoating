...
- Name: navigation.spec.ts >> Site Navigation >> Header navigation (desktop) >> header has store logo/name link
- Location: tests/navigation.spec.ts:10:9
...
Locator: locator('header a[href="/eniwa"]')
Expected: visible
Error: strict mode violation: locator('header a[href="/eniwa"]') resolved to 2 elements:
    1) <a href="/eniwa" class="flex items-center gap-2.5 text-[#0C3290]">…</a> aka getByRole('link', { name: 'KeePer 恵庭店' })
    2) <a href="/eniwa" class="text-gray-600 text-[13px] hover:text-black transition-colors">ホーム</a> aka getByRole('banner').getByRole('link', { name: 'ホーム' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('header a[href="/eniwa"]')
