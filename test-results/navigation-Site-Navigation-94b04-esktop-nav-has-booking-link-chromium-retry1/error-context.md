...
- Name: navigation.spec.ts >> Site Navigation >> Header navigation (desktop) >> desktop nav has booking link
- Location: tests/navigation.spec.ts:21:9
...
Locator: locator('nav a[href="/eniwa/booking"]')
Expected: visible
Error: strict mode violation: locator('nav a[href="/eniwa/booking"]') resolved to 2 elements:
