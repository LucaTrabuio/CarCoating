...
- Name: navigation.spec.ts >> Site Navigation >> Header navigation (desktop) >> desktop nav has price/estimate link
- Location: tests/navigation.spec.ts:36:9
...
Locator: locator('nav a[href="/eniwa/price"]')
Expected: visible
Error: strict mode violation: locator('nav a[href="/eniwa/price"]') resolved to 2 elements:
    1) <a href="/eniwa/price" class="text-gray-600 text-[13px] hover:text-black transition-colors">見積もり</a> aka getByRole('link', { name: '見積もり', exact: true })
    2) <a href="/eniwa/price" class="hover:text-white transition-colors">見積もり・料金</a> aka getByRole('link', { name: '見積もり・料金' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('nav a[href="/eniwa/price"]')
